				...
				foreach($new_consult_array as $c_array => $new_consult){
					...
					if($new_consult[4]=='m_patient_fp_method_service'){
						...
						while($get_all_result = mysql_fetch_array($get_all)){
							...
							//echo "<br /><br />$new_consult[7]<br /><br />";
...
echo "<br /><br />".mysql_num_rows($get_all)."<br /><br />";
...
echo "AAA SELECT * FROM $new_entry[4] WHERE patient_id = '$new_entry[0]' AND $where_field = '$new_entry[2]'";
						$get_mc_lite_date = mysql_query("SELECT * FROM $new_entry[4] WHERE patient_id = '$new_entry[0]' AND $where_field = '$new_entry[2]'")or die("Error 113 : ".mysql_error());
					}
					...
					while($get_mc_lite_result = mysql_fetch_array($get_mc_lite_date)){
						...
						if($new_entry[4]=="m_consult_vaccine"){
							...
							//echo "DFFF SELECT * FROM $new_entry[4] WHERE mc_id = '$mc_id' AND consult_id = '$consult_id' AND patient_id = '$patient_id' AND $field_to_find = '$get_mc_lite_result[$field_to_find]'";
					...
					while($get_mc_lite_result = mysql_fetch_array($get_mc_lite_date)){
						...
						switch($update_value[4]):
								...
								case 'm_patient_fp_method_service':
									...
									//33w$vaccine_id = $update_value[99];
									break;
								case 'm_consult_mc_vaccine':
									$mc_id = $update_value[7];
									$patient_id = $update_value[9];
						...
						if($update_value[4]=="m_consult_vaccine"){
							...
							//echo "SELECT * FROM $update_value[4] WHERE $spc_field = '$mc_id' AND patient_id = '$patient_id' AND $field_to_find = '$get_mc_lite_result[$field_to_find]'";
...
echo "ASD SELECT * FROM $update_value[4] WHERE mc_id = '$mc_id' AND consult_id = '$consult_id' AND patient_id = '$patient_id' AND $field_to_find = '$get_mc_lite_result[$field_to_find]'";
