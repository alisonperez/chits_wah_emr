<?php
   ...
   echo "<table border='1'>";
   echo "<tr align='center'><td colspan='6'><b>".$cat." from ".$_SESSION["sdate2"]." to ".$_SESSION["edate2"]."<b></td></tr>";
   echo "<tr><td>#</td><td>Last Name</td><td>First Name</td><td>Patient ID</td><td>Date of Birth</td><td>Barangay</td></tr>";
