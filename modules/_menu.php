...
if ($HTTP_GET_VARS["menu_id"]) {
	...
	case 1360:
		...
		break;
	case 1379:
		$alert->_sms_alert($menu_id, $HTTP_POST_VARS, $HTTP_GET_VARS,$_SESSION["validuser"],$_SESSION["isadmin"]);
		break;
	case 1370:
		$alert->_sms_config($menu_id, $HTTP_POST_VARS, $HTTP_GET_VARS,$_SESSION["validuser"],$_SESSION["isadmin"]);
		break;
	case 1374:
		$alert->_sms_enroll($menu_id, $HTTP_POST_VARS, $HTTP_GET_VARS,$_SESSION["validuser"],$_SESSION["isadmin"]);
		break;
	case 1329:
	...
	case 691:
		...
		break;
	case 1385:
		$gen_services->_gen_services($menu_id, $HTTP_POST_VARS, $HTTP_GET_VARS,$_SESSION["validuser"],$_SESSION["isadmin"]);
		break;
	case 1327:
	...
	case 717:
		...
		break;
	case 1380:
		$usage->_usage($menu_id, $HTTP_POST_VARS, $HTTP_GET_VARS,$_SESSION["validuser"],$_SESSION["isadmin"]);
		break;
	case 1214:
