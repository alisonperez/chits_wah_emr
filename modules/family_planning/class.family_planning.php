...
class family_planning extends module{
	...
	function fp_menu(){   			 /* displays main menus for FP */
		...
		echo "<tr><td>";		
	        ...
	        echo "<a href='$_SERVER[PHP_SELF]?page=$_GET[page]&menu_id=$_GET[menu_id]&consult_id=$_GET[consult_id]&ptmenu=$_GET[ptmenu]&module=$_GET[module]&fp=OBS#obs' class='fpmenu'>".$this->menu_highlight($_GET["fp"],'OBS','OBSTETRICAL HX')."</a>";
	...
	function form_fp_visit1(){
		...
		*/
		...
		echo "<tr><td class='boxtitle'>SEARCH PARTNER'S NAME</td>";
		echo "<td><input name='spouse_name' type='text' size='20' value='$name_spouse'></input>&nbsp;<input type='button' name='btn_search_spouse' value='Search' onclick='search_patient(this.form.name,this.form.elements[8].name,this.form.elements[1].name);' style='border: 1px solid #000000'></input>";
